...
const nav = '<nav><a href="/">Word Unscrambler</a><a href="/anagram-solver/">Anagram Solver</a><a href="/word-finder/">Word Finder</a><a href="/wordle-solver/">Wordle Solver</a><a href="/crossword-solver/">Crossword Solver</a><a href="/guides/">Guides</a></nav>';
const footer = '<div class="footerlinks"><a href="/">Word Unscrambler</a><a href="/anagram-solver/">Anagram Solver</a><a href="/word-finder/">Word Finder</a><a href="/guides/">Guides</a><a href="/about/">About</a><a href="/how-it-works/">How it works</a><a href="/editorial-policy/">Editorial policy</a><a href="/privacy/">Privacy</a><a href="/terms/">Terms</a><a href="/contact/">Contact</a></div>';
...
for (const entry of fs.readdirSync(root, { recursive: true, withFileTypes: true })) {
  ...
  const duplicateLinks = html.match(/href=["']\/word-unscrambler\/["']/gi) || [];
  if (duplicateLinks.length) {
    consolidatedLinks += duplicateLinks.length;
    html = html.replace(/href=["']\/word-unscrambler\/["']/gi, 'href="/"');
  }
...
console.log(`Canonicalized ${consolidatedLinks} internal /word-unscrambler/ links to the homepage.`);
